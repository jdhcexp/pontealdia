export const environment = {
  ...
  domain: 'localhost',
  gtmPruebas: true,
  APIEndpoint_authn: 'https://ws-authn-dev-co-sla-datacash.apps.appcanvas.net',
  APIEndpoint_company: 'https://ws-cmpnymnger-dev-co-sla-datacash.apps.appcanvas.net',
  APIEndpoint_debts: 'https://ws-debtsmanager-dev-co-sla-datacash.apps.appcanvas.net',
  APIEndpoint_ngttion: 'https://ws-ngttion-dev-co-sla-datacash.apps.appcanvas.net',
